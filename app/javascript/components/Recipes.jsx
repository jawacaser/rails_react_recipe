...
export default ({props}) => {
    ...
    return (
        <div className="primary-color">
            <section className="hero2 position-relative d-flex align-items-center justify-content-center">
                ...
                <div className="container position-relative w-75 container container-fluid text-center">
                    ...
                    <p className="rfs text-muted my-4">
                        ...
                        TODO: "Social Media" buttons?, prettier contact page,
            ...
            <div className="py-3 px-4 position-relative">
                <main id="recipe-list" className="Container bg-light bg-opacity-50 py-4 px-5">
                    <h2 className="display-5 mt-3">Featured Collection</h2>
                    <hr />
